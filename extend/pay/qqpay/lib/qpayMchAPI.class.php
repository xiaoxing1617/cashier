 ...
 * User: Tencent.com
 */
require_once (PAY_PATH.'qqpay/lib/qpayMchUtil.class.php');
class QpayMchAPI{
    protected $url;
    protected $isSSL;
    protected $timeout;
    ...
    public function reqQpay($params,$fun=""){
        $ret = array();
        //商户号
        ...
        if(isset($this->isSSL)){
            $ret =  QpayMchUtil::reqByCurlSSLPost($xml, $this->url, $this->timeout,$fun);
        }else{
            $ret =  QpayMchUtil::reqByCurlNormalPost($xml, $this->url, $this->timeout,$fun);
        }
        return $ret;
    }
