...
<body>
    ...
    <nav>
        <div class="menu">
            <p class="website_name">错误</p>
            <div class="menu_links">
                <a href="/" class="link">首页</a>
                <a href="http://www.96xy.cn/" class="link" target="_blank">星益云</a>
                <a href="http://www.thinkphp.cn/" class="link" target="_blank">ThinkPHP</a>
            </div>
            <div class="menu_icon">
                <span class="icon"></span>
            </div>
    ...
    <script src='/static/404/js/parallax.min.js'></script>
    <script src='/static/404/js/jquery.min.js'></script>
    <script src="/static/404/js/script.js"></script>
    </body>
    </html>
    <?php if(\think\App::$debug) { ?>
    <script>
